---
title: "Usage with the paleoTS package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Usage with the paleoTS package}
...
This vignette explain how to link the `StratPal` package with the `paleoTS` package ([Hunt 2006](#References)). For details on the underlying data structures, see `vignette("StratPal_docs")`.
